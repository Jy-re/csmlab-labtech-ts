...
interface BrokenEquipmentProps {
  selectedItem: any; // Replace 'any' with the actual type of selectedItem
  onClose: () => void;
  onAddToTable: (quantity: number) => void;
}

const BrokenEquipment: React.FC<BrokenEquipmentProps> = ({ selectedItem, onClose, onAddToTable }) => {
  ...
  return (
    <div className="modal">
      <div className="modal-content">
        <h1 className='addText'>Select Broken Equipment</h1>
...
export default BrokenEquipment;